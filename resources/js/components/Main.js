                ...
                <div className="row">
                    <div className="col-md-8">
                        <div className="Main-Table">
                            <div className="Main-Table-Header" style={{backgroundColor:'#ecf0f1'}}>
                                <div className="Table-Row" style={{margin:'10px 0px 10px 0px'}}>
                                    <div className={`Table-Item Header`} onClick={()=>this.setSort('artistName')} style={{cursor:'pointer',display:'flex',justifyContent:'spac'}}>
                                        <div>
                                        artistName
                                        </div>
                                        <div className="Header-Icon">
                                        {this.state.sort[0].value != 0 && (
                                            <>
                                            {this.state.sort[0].value == 1 ?
                                    ...
                                    <div className={`Table-Item Header`} onClick={()=>this.setSort('musicName')} style={{cursor:'pointer',display:'flex',justifyContent:'spac'}}>
                                        <div>
                                        Name
                                        </div>
                                        <div className="Header-Icon">
                                        {this.state.sort[1].value != 0 && (
                                            <>
                                            {this.state.sort[1].value == 1 ?
                                            <i className="fa fa-arrow-up ml-1 mr-1" aria-hidden="true"></i> :
                                            <i className="fa fa-arrow-down ml-1 mr-1" aria-hidden="true"></i>
                                            }
                                            </>
                                    ...
                                    <div className={`Table-Item Header`} onClick={()=>this.setSort('genre')} style={{cursor:'pointer',display:'flex',justifyContent:'spac'}}>

                                        <div>
                                        Gender
                                        </div>
                                        <div className="Header-Icon">
                                        {this.state.sort[2].value != 0 && (
                                            <>
                                            {this.state.sort[2].value == 1 ?
                                            <i className="fa fa-arrow-up ml-1 mr-1" aria-hidden="true"></i> :
                                            <i className="fa fa-arrow-down ml-1 mr-1" aria-hidden="true"></i>
                                            }
                                            </>
                                    ...
                                    <div className={`Table-Item Header`} onClick={()=>this.setSort('year')} style={{cursor:'pointer',display:'flex',justifyContent:'spac'}}>

                                        <div>
                                        Year
                                        </div>
                                        <div className="Header-Icon">
                                        {this.state.sort[3].value != 0 && (
                                            <>
                                            {this.state.sort[3].value == 1 ?
                                            <i className="fa fa-arrow-up ml-1 mr-1" aria-hidden="true"></i> :
                                            <i className="fa fa-arrow-down ml-1 mr-1" aria-hidden="true"></i>
                                            }
                                            </>
                            ...
                            <div className="Main-Table-Content">
                                {Array.isArray(artist.data) && (
                                    ...
                                    {artist.data.map((item,index)=>{
                                        return(
                                            <div key={index} className="Table-Row justify-content-between border">
                                        ...
                                        {Array.isArray(artist.links) && (
                                            <>
                                                {artist.links.map((item,index)=>{
                                                    let classNameVal = 'm-1 btn circleBtn'
                                                    ...
                                                    return(
                                                        <div className={classNameVal} key={index} onClick={()=>this.getPage(item.url)}>
                                                            {label}
                                                        </div>
                                                    )
                                ...
                                <div className="row justify-content-center">
                                        <div className="paginationCntPanel row">
                                                {pgCntArray.map((item,index)=>{
                                                    let classNameVal = 'btn border btn-PgCnt'
                                                    if(this.state.pgCnt == item)
                                                    {
                                                        classNameVal = `${classNameVal} btn-select`
                                                    }
                                                    return(
                                                        <div className={classNameVal} onClick={()=>this.setPgCnt(item)}>
                                                            {item}
                                                        </div>
                                                    )
                                                })}
                    ...
                    <div className="col-md-4" style={{padding:'0px 20px 0px 20px'}}>
                        ...
                        <div>
                            ...
                            <select className="FilterSelect p-2"  onChange={this.onChangeArtistFilter}>
                        ...
                        <div>
                            ...
                            <select className="FilterSelect p-2" onChange={this.onChangeGenreFilter}>
                            <option value={'all'}>All</option>
                        ...
                        <div>
                            ...
                            <select className="FilterSelect p-2" onChange={this.onChangeYearFilter}>
                                <option value={'all'}>All</option>
